...
public static class DesignTokens
{
    ...
    public static class Typography
    {
        ...
        public static void Initialize()
        {
            ...
            try
            {
                ...
                if (_pfc.Families.Length >= 2) { _boldFamily = _pfc.Families[0]; _regularFamily = _pfc.Families[1]; }
                else if (_pfc.Families.Length == 1) { _boldFamily = _pfc.Families[0]; _regularFamily = _pfc.Families[0]; }
            }
            catch { _boldFamily = null; _regularFamily = null; }
        }
        ...
        private static Font CreateFont(float size, FontStyle style = FontStyle.Regular)
        {
            ...
            return family != null ? new Font(family, size, style) : new Font("Segoe UI", size, style);
        }
    ...
    {
        public const int FrameInterval = 16;
        public const int SmoothFrameInterval = 8;
        public const float SpringDamping = 0.72f;
        public const float SpringStiffness = 0.08f;
        public const float SpringDampingSnappy = 0.85f;
        public const float SpringStiffnessSnappy = 0.12f;
        public const float SpringDampingSoft = 0.6f;
        ...
        public static float EaseOutBack(float t) { const float c1 = 1.70158f; const float c3 = c1 + 1f; return 1f + c3 * MathF.Pow(t - 1f, 3f) + c1 * MathF.Pow(t - 1f, 2f); }
        public static float EaseOutElastic(float t) { if (t == 0f || t == 1f) return t; const float c4 = (2f * MathF.PI) / 3f; return MathF.Pow(2f, -10f * t) * MathF.Sin((t * 10f - 0.75f) * c4) + 1f; }
