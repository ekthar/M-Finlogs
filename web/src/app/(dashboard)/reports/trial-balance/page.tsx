  ...
  return (
    <motion.div initial="initial" animate="animate" className="space-y-5">
      <motion.div {...fadeUp} className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight text-zinc-900 dark:text-zinc-100">Trial Balance</h1>
          <p className="mt-0.5 text-sm text-zinc-500">Debit and credit totals per account</p>
        </div>
            ...
            <TableRow>
              <TableCell colSpan={3} className="h-32 text-center">
                <div className="flex flex-col items-center gap-2">
                  ...
                  <p className="text-sm text-zinc-500">Trial balance will load from your data</p>
                </div>
              </TableCell>
            </TableRow>
          </TableBody>
